    ...
    public class JobsController : ApiController
    {
                                                            ...
                                                            string maxDistanceLon = "1")
        {
            ...
            try
            {
                ...
                // Code to showcase exception profile dump in production 
                //int creatingDump = 0;
                //int dumpMe = 5 / creatingDump;
                // Code to showcase exception profile dump in production 

                telemetry.TrackEvent("API Search called");
        ...
        public async Task<DocumentSearchResult> SearchZipAsync(string zipCode)
        {
            ...
            try
            {
                telemetry.TrackEvent("API SearchZip called");
        ...
        public async Task<DocumentSuggestResult> Suggest(string searchText, bool fuzzy)
        {
            ...
            try
            {
                telemetry.TrackEvent("API Suggest called");
        ...
        public async Task<Document> LookUp(string id)
        {
            ...
            try
            {
                telemetry.TrackEvent("API Lookup called");
        ...
        public async Task Apply([FromBody]Application application)
        {
            try
            {
                telemetry.TrackEvent("API Apply called");
                ...
                var client = QueueClient.CreateFromConnectionString(ConfigurationManager.AppSettings["ServiceBusConnection"], "jobapplications");
